...
class Config:
    ...
    MONGODB_COLLECTION = os.environ.get("MONGODB_COLLECTION", "podcasts")
    VECTOR_INDEX = os.environ.get("VECTOR_INDEX", "podcast_vector_index")
    SEARCH_INDEX = os.environ.get("SEARCH_INDEX", "podcast_search_index")
